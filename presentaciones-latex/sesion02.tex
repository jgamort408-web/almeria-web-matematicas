  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \node[font=\tiny, color=AlmGris] at (1.3,-0.28)
    ...
    \begin{column}{0.44\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.82]
          ...
          \node[font=\tiny\bfseries, color=AlmAzulM]
            at (2.6,-0.52) {370 m};
          % Acotación anchura
          ...
          \node[font=\tiny\bfseries, color=AlmAzulM,
            ...
            at (5.62,0.7) {50 m};
          % Etiqueta
          \node[font=\scriptsize\bfseries, color=AlmAzul]
            at (2.6,0.7) {Rambla de Almería};
          % Flecha norte
          \node[font=\tiny, color=AlmGris] at (0.35,1.15)
            {N$\uparrow$};
        \end{tikzpicture}
      \end{center}
      \vspace{4pt}
      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.78]
          ...
          \node[font=\small\bfseries, color=AlmAzulM]
            at (2.25,2.4) {35 ha};
          \node[font=\footnotesize, color=AlmGris]
          ...
          \node[font=\tiny, color=AlmVerde!70!black]
            at (0.75,0.57) {\(\approx\)campo};
          % Acotación
          \draw[acota] (0,-0.28) -- (4.5,-0.28);
          \node[font=\tiny, color=AlmGris] at (2.25,-0.52)
            {escala aprox.};
        \end{tikzpicture}
      \end{center}
      \vspace{2pt}
