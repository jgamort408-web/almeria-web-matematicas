      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.72]
          ...
          \draw[recto, ->] (-3.4,0) -- (3.6,0)
            node[right, font=\small\bfseries, color=AlmAzulM] {$x$};
          \draw[recto, ->] (0,-3.4) -- (0,3.6)
            node[above, font=\small\bfseries, color=AlmAzulM] {$y$};
          % Cuadrícula ligera
          ...
          \foreach \i in {-3,-2,-1,1,2,3}{
            ...
            \draw[AlmAzulM, line width=0.6pt]
              (-0.08,\i) -- (0.08,\i);
            \node[font=\tiny, color=AlmGris] at (\i,-0.28) {\i};
            \node[font=\tiny, color=AlmGris] at (-0.28,\i) {\i};
          }
          % Origen
          \node[font=\tiny, color=AlmGris] at (-0.28,-0.28) {0};
          % Indicadores de dirección
          \node[font=\tiny\bfseries, color=AlmTerra] at (2.2,-0.45)
            {$+$};
          \node[font=\tiny\bfseries, color=AlmTerra] at (-2.2,-0.45)
            {$-$};
          \node[font=\tiny\bfseries, color=AlmTerra] at (0.35,2.3)
            {$+$};
          \node[font=\tiny\bfseries, color=AlmTerra] at (0.35,-2.3)
            {$-$};
        \end{tikzpicture}
    ...
    \begin{column}{0.46\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.75]
          ...
          % Marcas
          \foreach \i in {1,2,3,4}{
            \node[font=\tiny, color=AlmGris] at (\i,-0.25) {\i};
          }
          \foreach \j in {1,2,3}{
            \node[font=\tiny, color=AlmGris] at (-0.22,\j) {\j};
          }
          \node[font=\tiny, color=AlmGris] at (-0.22,-0.22) {0};
          % Punto A(3,2)
          \node[punto] (A) at (3,2) {};
          \node[font=\small\bfseries, color=AlmAzulM, above right=1pt]
            at (A) {$A(3,\,2)$};
          % Flechas de desplazamiento
          \draw[AlmTerra, ->, line width=1.2pt, dashed]
            (0,0) -- (3,0)
            node[midway, below, font=\tiny\bfseries, color=AlmTerra]
            {$x=3$};
          \draw[AlmVerde, ->, line width=1.2pt, dashed]
            (3,0) -- (3,2)
            node[midway, right, font=\tiny\bfseries, color=AlmVerde]
            {$y=2$};
        \end{tikzpicture}
      \end{center}
    \end{column}
    ...
    \begin{column}{0.44\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.80]
          ...
          \node[font=\normalsize\bfseries, color=AlmAzul]
            at (1.5, 1.5)  {I};
          \node[font=\normalsize\bfseries, color=AlmAmbar!80!black]
            at (-1.5, 1.5) {II};
          \node[font=\normalsize\bfseries, color=AlmTerra]
            at (-1.5,-1.5) {III};
          \node[font=\normalsize\bfseries, color=AlmVerde]
            at (1.5,-1.5)  {IV};
          % Signos en cuadrantes
          \node[font=\tiny, color=AlmAzul]
            at (1.5, 0.9) {$(+,+)$};
          \node[font=\tiny, color=AlmAmbar!80!black]
            at (-1.5, 0.9) {$(-,+)$};
          \node[font=\tiny, color=AlmTerra]
            at (-1.5,-0.9) {$(-,-)$};
          \node[font=\tiny, color=AlmVerde]
            at (1.5,-0.9)  {$(+,-)$};
          % Origen
          \node[font=\tiny, color=AlmGris] at (-0.22,-0.22) {O};
        \end{tikzpicture}
      \end{center}
    \end{column}
      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.72]
          ...
          \foreach \i in {-4,-3,-2,-1,1,2,3,4,5}{
            \node[font=\tiny, color=AlmGris] at (\i,-0.3) {\i};
          }
          \foreach \j in {-3,-2,-1,1,2,3,4}{
            \node[font=\tiny, color=AlmGris] at (-0.3,\j) {\j};
          }
          \node[font=\tiny, color=AlmGris] at (-0.28,-0.28) {0};
          % Punto A(3,2)
          \node[punto] (A) at (3,2) {};
          \node[font=\scriptsize\bfseries, color=AlmAzulM,
                above right=0pt] at (A) {$A(3,2)$};
          % Punto B(-4,1)
          \node[puntot] (B) at (-4,1) {};
          \node[font=\scriptsize\bfseries, color=AlmTerra,
                above right=0pt] at (B) {$B(-4,1)$};
          % Punto C(-2,-3)
          \node[puntov] (C) at (-2,-3) {};
          \node[font=\scriptsize\bfseries, color=AlmVerde,
                above right=0pt] at (C) {$C(-2,-3)$};
          % Punto D(5,-1)
          \node[circle, fill=BCrear, inner sep=2.2pt,
                draw=AlmBlanco, line width=0.8pt] (D) at (5,-1) {};
          \node[font=\scriptsize\bfseries, color=BCrear,
                above left=0pt] at (D) {$D(5,-1)$};
          % Punto E(0,4)
          \node[circle, fill=BAplicar, inner sep=2.2pt,
                draw=AlmBlanco, line width=0.8pt] (E) at (0,4) {};
          \node[font=\scriptsize\bfseries, color=BAplicar!80!black,
      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.82]
          ...
          \draw[recto, ->] (0,0)--(4.5,0)
            node[right,font=\tiny\bfseries, color=AlmAzulM]{$x$};
          \draw[recto, ->] (0,0)--(0,3.8)
            node[above,font=\tiny\bfseries, color=AlmAzulM]{$y$};
          % Marcas
          \foreach \i in {1,2,3,4}{
            \node[font=\tiny, color=AlmGris] at (\i,-0.22) {\i};
          }
          \foreach \j in {1,2,3}{
            \node[font=\tiny, color=AlmGris] at (-0.22,\j) {\j};
          }
          \node[font=\tiny, color=AlmGris] at (-0.18,-0.18){0};
          % Punto P(3,2) — Alcazaba aprox.
          \node[puntot] (P) at (3,2) {};
          \node[font=\tiny\bfseries, color=AlmTerra, above right=0pt]
            at (P) {Alcazaba};
          \node[font=\tiny, color=AlmTerra, below right=0pt]
            at (P) {$(3,2)$};
          % Acotación x
          \draw[acota] (0,-0.48) -- (3,-0.48);
          \node[font=\tiny, color=AlmAzulM] at (1.5,-0.72) {$300\ \text{m}$};
          % Acotación y
          \draw[acota] (3.5,0) -- (3.5,2);
          \node[font=\tiny, color=AlmAzulM, rotate=90, anchor=south]
            at (3.75,1) {$200\ \text{m}$};
          % Escala
          \node[font=\tiny, color=AlmGris, align=center]
