    ...
    \begin{column}{0.44\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.9]
          ...
          \node[text=AlmBlanco, font=\tiny\bfseries] at (1.6,3.9)
            {ALMERÍA};
          \fill[AlmAzulC!40]
            (0.15,2.1) rectangle (3.05,3.5);
          \node[text=AlmAzul, font=\tiny] at (1.6,2.8)
            {mapa de la ciudad};
          \foreach \y in {1.2,0.85,0.5}{
            \fill[AlmBlanco!30, rounded corners=1pt]
              (0.3,\y) rectangle (2.8,\y+0.22);
          }
          \node[text=AlmAmbar, font=\tiny\bfseries] at (1.6,0.05)
            {Guía Turística};
        \end{tikzpicture}
      \end{center}
    \end{column}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.42\textwidth}
      \begin{tikzpicture}[every node/.style={font=\scriptsize}]
        ...
        \node[text=AlmAzul, font=\tiny\bfseries, align=center] at (-1.4,0) {Guía\\clásica};
        \node[text=AlmAzul, font=\tiny\bfseries] at (2.0,0) {Matemáticas};
        \node[text=AlmNegro, font=\tiny\bfseries, align=center] at (0,0)
          {Guía\\matemática};
        \node[text=AlmGris, font=\tiny, align=center] at (-1.5,-0.55)
          {fotos\\textos};
        \node[text=AlmGris, font=\tiny, align=center] at (1.6,-0.55)
          {cálculos\\gráficas};
        \node[text=AlmAzul, font=\tiny, align=center] at (0,0.55)
          {datos\\medidas};
      \end{tikzpicture}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.37\textwidth}
      ...
      \begin{tikzpicture}[scale=0.75]
        ...
        \node[font=\tiny, color=AlmAzul] at (0.9,0.4)
          {campo fútbol};
        \node[font=\scriptsize\bfseries, color=AlmAzul] at (1.9,1.2)
          {$35\ \text{ha}$};
        \node[font=\tiny, color=AlmGris] at (1.9,0.7)
          {Puerto};
      \end{tikzpicture}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[T]
    \begin{column}{0.31\textwidth}
      \begin{recordarbox}
        ...
        una guía turística.\par\vspace{4pt}
    ...
    \begin{column}{0.31\textwidth}
      \begin{comprenderbox}
        ...
        y se recorre a $4\ \text{km/h}$.\par\vspace{4pt}
    ...
    \begin{column}{0.31\textwidth}
      \begin{analizarbox}
        \footnotesize
        Observa tres monumentos de tu elección.\par\vspace{4pt}
        \textbf{Extrae} al menos 2 preguntas
        matemáticas que podrían incluirse en
        una guía turística para cada uno.\par\vspace{4pt}
