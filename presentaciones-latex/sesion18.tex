...
\begin{frame}{Las 7 secciones de vuestra guía (1/2)}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{enumerate}
        \item[\faBookOpen] \textbf{Portada}\\
          {\AlmFontFootnote Título, autores, estadística llamativa, miniatura del mapa}
        \vspace{4pt}
        \item[\faMapMarkerAlt] \textbf{Mapa con coordenadas}\\
          {\AlmFontFootnote $\geq 10$ puntos turísticos con $(x,y)$, escala y rosa de los vientos}
      \end{enumerate}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{enumerate}
        ...
        \item[\faTable] \textbf{Monumentos en cifras}\\
          {\AlmFontFootnote Tabla: nombre, coordenadas, área/altura y visitantes por año}
        \vspace{4pt}
        \item[\faRoute] \textbf{Rutas matemáticas}\\
          {\AlmFontFootnote 2--3 rutas con distancias calculadas y tiempo estimado}
      \end{enumerate}
    \end{column}
  \end{columns}
  \vspace{8pt}
  \begin{notabox}[Consejo]
    \AlmFontFootnote
    Estas cuatro partes construyen el esqueleto de la guía:
    portada, mapa, tabla y rutas.
  \end{notabox}
\end{frame}

\begin{frame}{Las 7 secciones de vuestra guía (2/2)}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{enumerate}
        \setcounter{enumi}{4}
        \item[\faChartLine] \textbf{Gráficas de Almería}\\
          {\AlmFontFootnote $\geq 2$ gráficas (temperatura, turismo\ldots) con análisis}
        \vspace{4pt}
        \item[\faLightbulb] \textbf{Datos curiosos}\\
          {\AlmFontFootnote 5--8 hechos matemáticos sorprendentes de Almería}
      \end{enumerate}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{enumerate}
        ...
        \item[\faBook] \textbf{Glosario matemático}\\
          {\AlmFontFootnote $\geq 10$ términos usados en la guía con definición}
      \end{enumerate}
      \vspace{8pt}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.44\textwidth}
      \begin{tikzpicture}[scale=0.75]
        ...
        \draw[->, AlmAzulM] (0,0)--(6.4,0) node[right,font=\AlmFontTiny]{$x$};
        \draw[->, AlmAzulM] (0,0)--(0,5.8) node[above,font=\AlmFontTiny]{$y$};
        % Puntos
        \foreach \x/\y/\c/\n in {
          ...
          \node[font=\AlmFontTiny, above, color=\c] at (\x,\y) {\n};
        }
        % Ruta
        ...
        % Norte
        \node[font=\AlmFontLarge, color=AlmAzulM] at (5.5,5.2) {$\uparrow$N};
      \end{tikzpicture}
    \end{column}
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[
        ...
        fonttitle=\bfseries\AlmFontSmall\color{AlmBlanco},
    ...
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[
        ...
        fonttitle=\bfseries\AlmFontSmall\color{AlmAzul},
        attach boxed title to top left={yshift=-2.2mm, xshift=4mm},
      ...
      \begin{notabox}[Más datos\ldots]
        \begin{itemize}
          ...
          \item Almería recibe $\approx$\,\SI{3}{millones}
                de turistas al año.
          \item La temperatura media anual es \ensuremath{18{,}5\,^\circ\mathrm{C}}.
        \end{itemize}
      \end{notabox}
    \end{column}
  \end{columns}
...
\begin{frame}{¡Cuidado con este error!}
  \begin{errorbox}
    ...
    {\AlmFontFootnote ← Esto es una guía turística clásica, no matemática.}\\[8pt]
    ...
    {\AlmFontFootnote ← Mismo lugar, pero con contenido matemático real.}
  \end{errorbox}
\end{frame}
