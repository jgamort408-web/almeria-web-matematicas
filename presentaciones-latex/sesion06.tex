    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{tikzpicture}[scale=0.85]
        ...
        \foreach \p/\lbl/\pos in {
          ...
          (-0.4,1.3)/E/left}{
          \node[punto] at \p {};
          \node[\pos, font=\bfseries\AlmFontScript, color=AlmAzulM] at \p {\lbl};
        }
        % etiqueta lados
        \node[color=AlmTerra, font=\AlmFontTiny\bfseries] at (1,-0.3) {lado};
        % etiqueta vértice
        \draw[->, AlmTerra, thin] (0.6,-0.5) -- (-0.05,-0.05);
        \node[color=AlmTerra, font=\AlmFontTiny\bfseries] at (0.9,-0.55) {vértice};
      \end{tikzpicture}
      \end{center}
      \begin{notabox}[Clave]
        \AlmFontScript Un círculo \textbf{NO} es un polígono:
...
\begin{frame}{Galería de polígonos: de 3 a 8 lados}
  ...
  \begin{tikzpicture}[scale=0.78]
    ...
    \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (0.6,-0.12) {Triángulo};
    \node[below, font=\AlmFontTiny, color=AlmGris] at (0.6,-0.38) {3 lados / 180°};
    % ---- Cuadrilátero ----
    \draw[zona] (1.7,0) -- (3.1,0) -- (3.1,1.0) -- (1.7,1.0) -- cycle;
    \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (2.4,-0.12) {Cuadrilátero};
    \node[below, font=\AlmFontTiny, color=AlmGris] at (2.4,-0.38) {4 lados / 360°};
    % ---- Pentágono ----
    ...
    \end{scope}
    \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (4.0,-0.12) {Pentágono};
    \node[below, font=\AlmFontTiny, color=AlmGris] at (4.0,-0.38) {5 lados / 540°};
    % ---- Hexágono ----
    ...
    \end{scope}
    \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (5.7,-0.12) {Hexágono};
    \node[below, font=\AlmFontTiny, color=AlmGris] at (5.7,-0.38) {6 lados / 720°};
    % ---- Heptágono ----
    ...
    \end{scope}
    \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (7.4,-0.12) {Heptágono};
    \node[below, font=\AlmFontTiny, color=AlmGris] at (7.4,-0.38) {7 lados / 900°};
    % ---- Octógono ----
    ...
    \end{scope}
    \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (9.1,-0.12) {Octógono};
    \node[below, font=\AlmFontTiny, color=AlmGris] at (9.1,-0.38) {8 lados / 1080°};
  \end{tikzpicture}
  \end{center}
  \vspace{0.15cm}
  \begin{teoriabox}
    \AlmFontSmall\textbf{Regla clave:} en todo polígono, el número de lados
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{tikzpicture}[scale=0.8]
        \begin{scope}[shift={(0,0)}]
          ...
          \node[below, font=\AlmFontScript\bfseries, color=AlmVerde] at (0,-0.8) {Regular};
        \end{scope}
        \begin{scope}[shift={(1.9,0)}]
          \draw[rectov, fill=AlmVerde!15] (0,0) -- (1.2,0) -- (1.2,1.2) -- (0,1.2) -- cycle;
          \node[below, font=\AlmFontScript\bfseries, color=AlmVerde] at (0.6,-0.12) {Regular};
        \end{scope}
      \end{tikzpicture}
      \end{center}
    \end{column}
    \begin{column}{0.48\textwidth}
      ...
      \begin{tikzpicture}[scale=0.8]
        \begin{scope}[shift={(0,0)}]
          ...
          \node[below, font=\AlmFontScript\bfseries, color=AlmTerra] at (0.7,-0.12) {Irregular};
        \end{scope}
        \begin{scope}[shift={(2.2,0)}]
          \draw[rectot, fill=AlmTerra!12]
            (0,0.3) -- (1.1,0) -- (1.3,0.9) -- (0.8,1.3) -- (0.1,1.0) -- cycle;
          \node[below, font=\AlmFontScript\bfseries, color=AlmTerra] at (0.65,-0.12) {Irregular};
        \end{scope}
      \end{tikzpicture}
      \end{center}
    \end{column}
...
\begin{frame}{Cuadriláteros especiales}
  \begin{center}
  \begin{tikzpicture}[scale=0.78, every node/.style={font=\AlmFontTiny}]
    % Rectángulo
    ...
    \node[below=24pt, color=AlmGris] at (5.4,0) {ángulos $\neq$ 90\textdegree};
    % Trapecio
  ...
  \begin{notabox}[Jerarquía]
    \AlmFontSmall Cuadrado $\subset$ Rectángulo $\subset$ Paralelogramo $\subset$ Cuadrilátero
  \end{notabox}
\end{frame}
  ...
  \begin{columns}[t]
    \begin{column}{0.50\textwidth}
      ...
      \begin{tikzpicture}[scale=0.75]
        ...
        \node[below, font=\AlmFontTiny\bfseries, color=AlmVerde] at (0.5,-0.05) {Equilátero};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (0.5,-0.25) {3 lados iguales};
        % Isósceles
        \draw[zona]
          (1.8,0) -- (3.2,0) -- (2.5,1.1) -- cycle;
        \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (2.5,-0.05) {Isósceles};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (2.5,-0.25) {2 lados iguales};
        % Escaleno
        \draw[rectot, fill=AlmTerra!10]
          (4.0,0) -- (5.6,0) -- (5.2,1.0) -- cycle;
        \node[below, font=\AlmFontTiny\bfseries, color=AlmTerra] at (4.9,-0.05) {Escaleno};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (4.9,-0.25) {todos distintos};
      \end{tikzpicture}
      \end{center}
    \end{column}
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[scale=0.75]
        ...
        \node[below, font=\AlmFontTiny\bfseries, color=AlmVerde] at (0.7,-0.05) {Acutángulo};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (0.7,-0.25) {todos $<$ 90°};
        % Rectángulo
        \draw[zona]
          (1.9,0) -- (3.3,0) -- (1.9,1.0) -- cycle;
        \draw[rectoang] (1.9,0) -- (2.2,0) -- (2.2,0.3) -- (1.9,0.3);
        \node[below, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (2.6,-0.05) {Rectángulo};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (2.6,-0.25) {un ángulo $=90°$};
        % Obtusángulo
        \draw[rectot, fill=AlmTerra!10]
          (4.0,0.5) -- (5.6,0) -- (4.3,1.1) -- cycle;
        \node[below, font=\AlmFontTiny\bfseries, color=AlmTerra] at (4.9,-0.05) {Obtusángulo};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (4.9,-0.25) {un ángulo $>90°$};
      \end{tikzpicture}
      \end{center}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[scale=0.72]
        ...
        \node[font=\AlmFontTiny\bfseries, color=AlmAzul] at (1.8,0.2) {Rectángulos};
        \node[font=\AlmFontTiny\bfseries, color=AlmTerra] at (1.8,2.55) {Triángulo};
      \end{tikzpicture}
      \end{center}
      \begin{notabox}[Dato]
        \AlmFontScript La Catedral de Almería (s. XVI) es una de las
...
\begin{frame}{Ejercicio 1 — RECORDAR \dificultad{1}}
  ...
  \vspace{0.15cm}
  \begin{notabox}[Pista]
    \AlmFontSmall Suma de ángulos $= (n-2)\times 180°$, donde $n$ es el número de lados.
  \end{notabox}
\end{frame}
...
\begin{frame}{Ejercicio 3 — APLICAR \dificultad{3}}
  ...
  \begin{notabox}[Recuerda]
    \AlmFontSmall Cuenta los lados visibles. Comprueba si todos los lados
  ...
  \begin{columns}[c]
    \begin{column}{0.30\textwidth}
      ...
      \begin{tikzpicture}[scale=0.65]
        ...
        \node[below, font=\AlmFontTiny\bfseries] at (0.7,-0.1) {Cuadrado};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (0.7,-0.35) {$l = l$};
      \end{tikzpicture}
      \end{center}
    \end{column}
    \begin{column}{0.30\textwidth}
      ...
      \begin{tikzpicture}[scale=0.65]
        ...
        \draw[rectoang] (0,0) -- (0.25,0) -- (0.25,0.25) -- (0,0.25);
        \node[below, font=\AlmFontTiny\bfseries] at (1.0,-0.1) {Rectángulo};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (1.0,-0.35) {$l \neq w$};
      \end{tikzpicture}
      \end{center}
    \end{column}
