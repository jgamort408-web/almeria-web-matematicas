  ...
  \begin{columns}[c]
    \begin{column}{0.54\textwidth}
      ...
      \begin{notabox}[Analogía]
        \AlmFontSmall El perímetro es como la \textbf{valla} que rodea un parque:
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \node[font=\AlmFontSmall\bfseries, color=AlmVerde] at (1.6,1.0) {ÁREA};
        \node[font=\AlmFontSmall\bfseries, color=AlmTerra] at (1.6,-0.35) {PERÍMETRO (valla)};
        % Flechas de las dimensiones
        \draw[acota] (0,-0.6) -- (3.2,-0.6)
          node[midway, below, font=\AlmFontScript] {$l$};
        \draw[acota] (3.6,0) -- (3.6,2.0)
          node[midway, right, font=\AlmFontScript] {$w$};
      \end{tikzpicture}
      \end{center}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{notabox}[Nunca olvides]
        \AlmFontSmall La unidad del perímetro es de
  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[scale=0.70]
        ...
        \node[above, font=\AlmFontTiny\bfseries, color=AlmAzulM] at (2.0,0.8) {Parque};
        \draw[acota] (0,-0.35) -- (4.0,-0.35)
          node[midway,below,font=\AlmFontTiny]{400 m};
        \draw[acota] (4.3,0) -- (4.3,0.8)
          node[midway,right,font=\AlmFontTiny]{80 m};
        % Triángulo
        \draw[zonat] (0,1.5) -- (2.2,1.5) -- (1.5,2.5) -- cycle;
        \node[above, font=\AlmFontTiny\bfseries, color=AlmTerra] at (1.1,2.5) {Plaza $\blacktriangle$};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (1.1,1.45) {120 m};
        % Cuadrado
        \draw[rectov, fill=AlmVerde!15] (2.8,1.5) rectangle (4.0,2.7);
        \node[above, font=\AlmFontTiny\bfseries, color=AlmVerde] at (3.4,2.7) {Plaza $\square$};
        \node[below, font=\AlmFontTiny, color=AlmGris] at (3.4,1.45) {60 m};
      \end{tikzpicture}
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}{Problema resuelto: manzana de Almería}
  \begin{definicionbox}{Enunciado}
    \AlmFontSmall Una manzana rectangular del centro de Almería mide
  ...
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \begin{pasobox}[1]
        \AlmFontSmall Identificar la fórmula:
        \[P = 2(l + w)\]
      \end{pasobox}
      \vspace{0.2cm}
      \begin{pasobox}[2]
    ...
    \begin{column}{0.48\textwidth}
      \begin{pasobox}[3]
        \AlmFontSmall Convertir a km para calcular el tiempo:
        \[600\ \text{m} = 0{,}6\ \text{km}\]
      \end{pasobox}
      \vspace{0.2cm}
      \begin{pasobox}[4]
        \AlmFontSmall Calcular el tiempo:
...
\begin{frame}{Comparativa: perímetros de zonas de Almería}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      xtick=data,
      xticklabel style={font=\AlmFontScript, align=center, text width=2.5cm},
  ...
  \begin{notabox}[Observa]
    \AlmFontSmall El Parque Nicolás Salmerón tiene el mayor perímetro (960 m)
    ...
    \begin{column}{0.32\textwidth}
      ...
      \begin{tikzpicture}[scale=0.7]
        ...
        \draw[acota] (0,-0.45) -- (2.4,-0.45)
          node[midway,below,font=\AlmFontTiny]{8 cm};
        \draw[acota] (2.75,0) -- (2.75,1.5)
          node[midway,right,font=\AlmFontTiny]{5 cm};
      \end{tikzpicture}
      \end{center}
    \end{column}
    \begin{column}{0.32\textwidth}
      ...
      \begin{tikzpicture}[scale=0.7]
        ...
        \draw[acota] (0,-0.45) -- (1.8,-0.45)
          node[midway,below,font=\AlmFontTiny]{7 m};
      \end{tikzpicture}
      \end{center}
    \end{column}
    \begin{column}{0.32\textwidth}
      ...
      \begin{tikzpicture}[scale=0.7]
        ...
        \node[below,font=\AlmFontTiny,color=AlmGris] at (1.2,-0.1) {6 m};
        \node[right,font=\AlmFontTiny,color=AlmGris] at (2.1,0.75) {8 m};
        \node[left,font=\AlmFontTiny,color=AlmGris] at (0.9,0.75) {10 m};
      \end{tikzpicture}
      \end{center}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[c]
    \begin{column}{0.46\textwidth}
      \begin{tikzpicture}[scale=0.7]
        ...
        \node[font=\AlmFontScript\bfseries, color=AlmAzulM] at (1.6,0.8) {Parque A};
        \draw[acota] (0,-0.4) -- (3.2,-0.4)
          node[midway,below,font=\AlmFontTiny]{200 m};
        \draw[acota] (3.55,0) -- (3.55,1.6)
          node[midway,right,font=\AlmFontTiny]{100 m};
      \end{tikzpicture}
    \end{column}
    \begin{column}{0.46\textwidth}
      \begin{tikzpicture}[scale=0.7]
        \draw[rectov, fill=AlmVerde!15] (0,0) rectangle (2.4,2.4);
        \node[font=\AlmFontScript\bfseries, color=AlmVerde] at (1.2,1.2) {Parque B};
        \draw[acota] (0,-0.4) -- (2.4,-0.4)
          node[midway,below,font=\AlmFontTiny]{150 m};
      \end{tikzpicture}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Ejercicio 3 — APLICAR \dificultad{3}}
  \begin{aplicarbox}
    \AlmFontSmall El \textbf{Parque de las Familias} de Almería tiene forma
  ...
  \begin{columns}[c]
    \begin{column}{0.52\textwidth}
      ...
      \begin{tikzpicture}[scale=0.55]
        ...
        \node[font=\AlmFontTiny, color=AlmGris] at (1.25,0.55) {250 m};
        \node[font=\AlmFontTiny, color=AlmGris] at (4.0,-0.25) {300 m};
        \node[font=\AlmFontTiny, color=AlmGris] at (6.25,1.15) {180 m};
        \node[font=\AlmFontTiny, color=AlmGris] at (5.95,2.85) {200 m};
        \node[font=\AlmFontTiny, color=AlmGris] at (3.15,3.55) {150 m};
        \node[font=\AlmFontTiny, color=AlmGris] at (0.45,2.45) {220 m};
        \node[font=\AlmFontScript\bfseries, color=AlmAzulM] at (3.25,1.75) {Parque};
      \end{tikzpicture}
      \end{center}
    \end{column}
    \begin{column}{0.44\textwidth}
      \begin{pasobox}[1]
        \AlmFontScript $P = 250 + 180 + 300 + 200 + 150 + 220 = ?$
      \end{pasobox}
      \vspace{0.2cm}
      \begin{pasobox}[2]
        \AlmFontScript Convertir 2 km a metros: $2\ \text{km} = 2000\ \text{m}$
        \\Vueltas $= 2000 \div P$
      \end{pasobox}
    \end{column}
  \end{columns}
