    ...
    \begin{column}{0.44\textwidth}
      \begin{tikzpicture}[
        ...
        \draw[flecha, dashed] (r) to[bend left=20] (c)
          node[midway, above right, font=\AlmFontTiny, color=AlmGris]
          {¿Todo bien?};
      \end{tikzpicture}
    \end{column}
  \end{columns}
...
\begin{frame}{Cuatro tipos de errores a buscar (1/2)}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[enhanced, colback=BRecordar!8,
        colframe=BRecordar, fonttitle=\bfseries\AlmFontSmall\color{AlmBlanco},
    ...
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[enhanced, colback=BAnalizar!8,
        colframe=BAnalizar, fonttitle=\bfseries\AlmFontSmall\color{AlmBlanco},
  ...
  \end{columns}
  \vspace{6pt}
  \begin{notabox}[Pista de revisión]
    \AlmFontFootnote
    Primero comprueba si el número está bien calculado;
    después verifica si el dato es fiable y tiene fuente.
  \end{notabox}
\end{frame}

\begin{frame}{Cuatro tipos de errores a buscar (2/2)}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[enhanced, colback=BComprender!8,
        colframe=BComprender, fonttitle=\bfseries\AlmFontSmall\color{AlmBlanco},
    ...
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[enhanced, colback=BEvaluar!8,
        colframe=BEvaluar, fonttitle=\bfseries\AlmFontSmall\color{AlmBlanco},
  ...
  \begin{notabox}[Pista de revisión]
    \AlmFontFootnote
    Aunque los datos sean correctos, una gráfica mal rotulada
    o una explicación vaga también cuentan como error.
  \end{notabox}
\end{frame}
...
\begin{frame}{Rúbrica de autoevaluación}
  ...
  \vspace{4pt}
  \begin{center}
    \AlmFontSmall\textbf{Puntuación máxima: 20 puntos}\\
    {\AlmFontFootnote 18--20: Sobresaliente · 14--17: Notable ·
