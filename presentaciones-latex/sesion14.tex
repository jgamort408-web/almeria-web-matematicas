      ...
      \begin{tikzpicture}[scale=0.82]
        \begin{axis}[
          ...
          \node[fill=AlmVerde!20, draw=AlmVerde, rounded corners,
                font=\AlmFontTiny\bfseries, inner sep=2pt]
            at (axis cs:2.5,19) {$y=19\,^\circ\mathrm{C}$};
          \node[fill=AlmVerde!20, draw=AlmVerde, rounded corners,
                font=\AlmFontTiny\bfseries, inner sep=2pt]
    ...
    \begin{column}{0.50\textwidth}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          % Máximo
          \node[above, font=\AlmFontTiny\bfseries, color=AlmTerra]
            at (axis cs:7.5,30) {\faArrowUp\ Máx: 30°C};
          % Mínimo
          \node[below right, font=\AlmFontTiny\bfseries, color=AlmAzulM]
            at (axis cs:1,12) {\faArrowDown\ Mín: 12°C};
          % Tendencia creciente
          \draw[->, AlmVerde, line width=1.2pt]
            (axis cs:2,14) -- (axis cs:6,26)
            node[midway, above left, font=\AlmFontTiny, color=AlmVerde]
            {creciente};
          % Tendencia decreciente
          \draw[->, BEvaluar, line width=1.2pt]
            (axis cs:8,29) -- (axis cs:11,17)
            node[midway, above right, font=\AlmFontTiny, color=BEvaluar]
            {decreciente};
        \end{axis}
      \end{tikzpicture}
    \end{column}
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          \addplot[AlmAmbar!70, dashed, line width=1pt]
            ...
            node[right, font=\AlmFontTiny, color=AlmAmbar!80!black]
            {20$^\circ$C};
        \end{axis}
      \end{tikzpicture}
    \end{column}
    ...
    \begin{column}{0.58\textwidth}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          ymin=0, ymax=3.5,
          nodes near coords style={font=\AlmFontTiny\bfseries},
          bar width=0.55cm,
        ]
...
\begin{frame}{Ejercicios multinivel}
  \begin{columns}[T]
    \begin{column}{0.31\textwidth}
      \begin{comprenderbox}
        \AlmFontFootnote\dificultad{1}\\[4pt]
