      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.85]
          ...
          \foreach \f/\ltr in {4/A, 3/B, 2/C, 1/D}{
            \node[font=\AlmFontSmall\bfseries, color=AlmAzul]
              at (-0.35, \f-0.5) {\ltr};
          }
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{formulabox}[AlmAzulM]
        ...
        \AlmFontLarge B3 \;=\; fila\,B\;,\;columna\,3
      \end{formulabox}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Mapa cuadriculado de Almería}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.05]
      ...
      \node[font=\AlmFontTiny\bfseries, color=AlmAzulM, above right=-1pt and 1pt of cat]
        {Catedral};
      \node[font=\AlmFontTiny, color=AlmGris, below right=-1pt and 1pt of cat]
        {B2};
      % Alcazaba: A2 -> col 2, fila A(=3) -> (1.5, 3.5)
      \node[puntot] (alc) at (1.5, 3.5) {};
      \node[font=\AlmFontTiny\bfseries, color=AlmTerra, above right=-1pt and 1pt of alc]
        {Alcazaba};
      \node[font=\AlmFontTiny, color=AlmGris, below right=-1pt and 1pt of alc]
        {A2};
      % Mercado Central: B3 -> col 3, fila B(=2) -> (2.5, 2.5)
      \node[puntov] (mer) at (2.5, 2.5) {};
      \node[font=\AlmFontTiny\bfseries, color=AlmVerde, above right=-1pt and 1pt of mer]
        {Mercado};
      \node[font=\AlmFontTiny, color=AlmGris, below right=-1pt and 1pt of mer]
        {B3};
      % Puerto: C4 -> col 4, fila C(=1) -> (3.5, 1.5)
      \node[punto, fill=BAplicar] (puer) at (3.5, 1.5) {};
      \node[font=\AlmFontTiny\bfseries, color=BAplicar!70!black,
            above right=-1pt and 1pt of puer]
        {Puerto};
      \node[font=\AlmFontTiny, color=AlmGris, below right=-1pt and 1pt of puer]
        {C4};
      ...
      \node[font=\AlmFontTiny\bfseries, color=AlmVerde,
        ...
        {P. Salmerón};
      \node[font=\AlmFontTiny, color=AlmGris, below left=-1pt and 1pt of par]
        {C3};
      % ------- Leyenda -------
      \node[font=\AlmFontTiny, color=AlmAzul, align=left,
