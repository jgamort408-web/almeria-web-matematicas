    ...
    \begin{column}{0.45\textwidth}
      ...
      \begin{tikzpicture}[scale=0.9]
        ...
        \node[draw=AlmAzul, fill=AlmAzulC!15, rounded corners=6pt,
              minimum width=6cm, minimum height=0.65cm,
              font=\AlmFontScript\bfseries, color=AlmAzul] (a) at (0, 2.2)
        ...
        \node[draw=AlmAmbar!80!black, fill=AlmAmbar!15, rounded corners=6pt,
              ...
              font=\AlmFontScript\bfseries, color=AlmAzul] (b) at (0, 1.1)
          {Datos candidatos};
        \node[draw=AlmVerde, fill=AlmVerde!15, rounded corners=6pt,
              minimum width=1cm, minimum height=0.65cm,
              font=\AlmFontScript\bfseries, color=AlmVerde] (c) at (0, 0)
          {Datos seleccionados};
        \draw[->, thick, AlmAzulM] (a) -- (b);
        \draw[->, thick, AlmAmbar!70!black] (b) -- (c);
        \node[right=0.1cm of a, font=\AlmFontTiny, color=AlmGris] {100\%};
        \node[right=0.1cm of b, font=\AlmFontTiny, color=AlmGris] {50\%};
        \node[right=0.1cm of c, font=\AlmFontTiny, color=AlmGris] {25\%};
      \end{tikzpicture}
      \end{center}
...
\begin{frame}{Árbol de decisión: ¿incluyo este dato?}
  ...
  \begin{tikzpicture}[
    decision/.style={diamond, draw=AlmAzulM, fill=AlmAzulC!20,
                     text width=2.6cm, align=center, font=\AlmFontTiny\bfseries,
                     inner sep=1pt, aspect=1.8},
    result/.style={rounded corners=4pt, draw=AlmVerde, fill=AlmVerde!15,
                   font=\AlmFontTiny\bfseries, text width=2cm, align=center, inner sep=3pt},
    reject/.style={rounded corners=4pt, draw=AlmTerra, fill=AlmTerra!10,
                   font=\AlmFontTiny\bfseries, text width=1.8cm, align=center, inner sep=3pt},
    arr/.style={->, >=Stealth, thick, AlmAzulM},
    scale=0.9, every node/.style={font=\AlmFontTiny}
  ]
    ...
    \draw[arr] (Q1) -- node[above,sloped]{\AlmFontTiny No} (R1);
    \draw[arr] (Q1) -- node[above]{\AlmFontTiny Sí} (Q2);
    \draw[arr] (Q2) -- node[above]{\AlmFontTiny No} (R2);
    \draw[arr] (Q2) -- node[right]{\AlmFontTiny Sí} (Q3);
    \draw[arr] (Q3) -- node[above]{\AlmFontTiny No} (R3);
    \draw[arr] (Q3) -- node[right]{\AlmFontTiny Sí} (OK);
  \end{tikzpicture}
  \end{center}
\end{frame}
  ...
  \begin{tikzpicture}
    \foreach \i/\cat/\col in {
      ...
      \node[draw=\col, fill=\col!12, rounded corners=3pt,
            font=\AlmFontTiny\bfseries\color{\col}, inner sep=4pt,
