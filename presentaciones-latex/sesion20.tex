  ...
  \begin{center}
    \begin{tikzpicture}[
      bloque/.style={
        ...
        text width=8.4cm, align=left,
        inner sep=7pt, font=\AlmFontSmall
      },
      tiempo/.style={
        circle, fill=AlmAmbar, text=AlmAzul,
        font=\bfseries\AlmFontSmall, inner sep=3pt,
        minimum size=0.8cm
      }
    ]
      ...
      \node[bloque, right=0.3cm of t1] {
        \textbf{Introducción}\\
        {\AlmFontFootnote Equipo, objetivo del proyecto,
      ...
      \node[bloque, right=0.3cm of t2] {
        ...
        {\AlmFontFootnote Un cálculo completo (área, distancia, etc.)
      ...
      \node[bloque, right=0.3cm of t3] {
        ...
        {\AlmFontFootnote El dato de Almería que más os ha sorprendido
        y por qué tiene importancia matemática.}
      };
      \node[tiempo] (t4) at (0,0.3) {1'};
      \node[bloque, right=0.3cm of t4] {
        \textbf{Reflexión}\\
        {\AlmFontFootnote Una cosa que habéis aprendido y una
...
\begin{frame}{Exposición oral — apoyo y preguntas}
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{teoriabox}
        \AlmFontFootnote
        \textbf{Antes de salir a exponer:}
        \begin{itemize}
          \item Comprobad quién presenta cada parte.
          \item Preparad qué señalaréis en el mapa o en la gráfica.
          \item Ensayad el vocabulario matemático clave.
        \end{itemize}
      \end{teoriabox}
    \end{column}
  \end{columns}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Excusarse continuamente: «Sé que no está bien pero\ldots»\\
              {\AlmFontFootnote Si sabes que hay un error,
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.38\textwidth}
      ...
      \begin{tcolorbox}[colback=AlmVerde!8, colframe=AlmVerde,
                        arc=4pt, boxrule=0.5pt, fontupper=\AlmFontSmall]
...
\begin{frame}{Rúbrica de evaluación de la exposición oral}
  ...
  \vspace{4pt}
  \begin{center}
    {\AlmFontSmall 9--10: Sobresaliente \quad 7--8: Notable \quad
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.41\textwidth}
      \begin{tikzpicture}[scale=0.7]
        ...
        \fill[AlmAmbar]
          (0,6.2) rectangle (5,7);
        \node[text=AlmAzul, font=\AlmFontTiny\bfseries] at (2.5,6.6)
          {ALMERÍA EN CIFRAS Y FORMAS};
        \fill[AlmAzulC!30] (0.3,4.6) rectangle (4.7,6.0);
        \node[text=AlmAzul, font=\AlmFontTiny, align=center] at (2.5,5.3)
          {mapa + coordenadas};
        \fill[AlmAmbar!20] (0.3,3.5) rectangle (2.2,4.4);
        \node[text=AlmNegro, font=\AlmFontTiny, align=center] at (1.25,3.95)
          {tabla\\monum.};
        \fill[AlmVerde!20] (2.5,3.5) rectangle (4.7,4.4);
        \node[text=AlmNegro, font=\AlmFontTiny, align=center] at (3.6,3.95)
          {gráfica\\turistas};
        \foreach \y in {2.7,2.3,1.9,1.5,1.1,0.7}{
          \fill[AlmBlanco!20] (0.3,\y) rectangle (4.7,\y+0.22);
        }
        \node[text=AlmAmbar, font=\AlmFontTiny] at (2.5,0.3)
...
\begin{frame}{Evidencia del día}
  \begin{evidenciabox}
    ...
    \vspace{6pt}
    \begin{center}
      \AlmFontLarge\color{AlmAmbar}
      {\AlmFontLargeUp\faAward}\quad
...
\begin{frame}{Cierre del proyecto — Almería en Cifras y Formas}
  \begin{center}
    \begin{tikzpicture}
      ...
      \node[text=AlmBlanco, font=\AlmFontLargeUp\bfseries] at (0,0.6)
        {Almería en Cifras y Formas};
      \node[text=AlmAmbar, font=\AlmFontNormal] at (0,-0.1)
        {20 sesiones · 4 bloques · 1 guía turística matemática};
      \node[text=AlmBlanco!70, font=\AlmFontSmall] at (0,-0.8)
        {Matemáticas 1.º ESO · \InstituteName};
      \node[text=AlmBlanco!55, font=\AlmFontFootnote] at (0,-1.4)
        {\AuthorName · \SchoolYear};
      % Estrellas decorativas
      \foreach \a in {0,60,...,300}{
        \node[text=AlmAmbar, opacity=0.35, font=\AlmFontScript]
          at (\a:4.2) {$\bigstar$};
      }
    \end{tikzpicture}
  \end{center}
  \vspace{4pt}
  \begin{center}
    {\color{AlmAzulM}\AlmFontLarge
    ¡Gracias por vuestro trabajo durante todo el proyecto!}\\[4pt]
    {\color{AlmGris}\AlmFontFootnote
