...
\begin{frame}[plain]
  ...
  \vspace{0.6cm}
  \begin{center}
    {\color{AlmAmbar}\AlmFontNormal\bfseries
      \faMapMarkerAlt\quad\ProjectName}\\[0.5cm]
    {\color{AlmBlanco}\AlmFontHugeUp\bfseries Presentaciones de aula}\\[0.3cm]
    {\color{AlmBlanco!70}\AlmFontLarge 20 sesiones · Guía teórica completa}\\[0.8cm]
    \begin{tcolorbox}[
      enhanced, width=0.72\textwidth,
      colback=AlmAzulM!50!AlmAzul,
      colframe=AlmAmbar, boxrule=1pt, arc=4pt,
      halign=center]
      {\color{AlmBlanco}\AlmFontSmall
