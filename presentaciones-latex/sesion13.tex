      ...
      \begin{notabox}[Datos → Gráfica → Conclusión]
        ...
        \begin{tikzpicture}[node distance=0.7cm,
            caja/.style={rounded corners=4pt, draw=AlmAzulM,
                         ...
                         align=center, font=\AlmFontTiny\bfseries}]
...
\begin{frame}{Elementos de una gráfica bien construida}
  \begin{columns}[T]
    \begin{column}{0.54\textwidth}
      \begin{center}
      \begin{tikzpicture}[font=\AlmFontScript, scale=0.88]
        % Ejes
        \draw[AlmAzulM, line width=1.2pt, -Stealth] (0,0)--(6.2,0)
          node[right, color=AlmAzulM, font=\AlmFontTiny\bfseries] {Mes ($x$)};
        \draw[AlmAzulM, line width=1.2pt, -Stealth] (0,0)--(0,4.2)
          node[above, color=AlmAzulM, font=\AlmFontTiny\bfseries,
        ...
        \draw[-Stealth, AlmTerra, thin] (5.4,3.8) -- (4.6,2.8)
          node[above right, color=AlmTerra, font=\AlmFontTiny\bfseries,
               xshift=8pt, yshift=4pt] {Título};
        \draw[-Stealth, AlmVerde, thin] (5.4,0.5) -- (0.7,0.5)
          node[above right, color=AlmVerde, font=\AlmFontTiny\bfseries,
               xshift=-24pt, yshift=6pt] {Barra};
        \node[AlmAzulM, font=\AlmFontTiny\bfseries] at (-1.1,2.0)
          {\rotatebox{90}{Escala $y$}};
        \node[AlmAzulM, font=\AlmFontTiny\bfseries] at (3.2,-0.5)
          {Etiquetas $x$};
      \end{tikzpicture}
      \end{center}
    \end{column}
...
\begin{frame}{Pasos para trazar una gráfica}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{pasobox}[1]
        \AlmFontSmall Decide el \textbf{tipo} de gráfica
        (¿barras o línea?).
      \end{pasobox}\vspace{3pt}
      \begin{pasobox}[2]
        \AlmFontSmall Dibuja los \textbf{ejes} $x$ (horizontal) e $y$ (vertical).
      \end{pasobox}\vspace{3pt}
      \begin{pasobox}[3]
        \AlmFontSmall \textbf{Etiqueta} cada eje: variable + unidad.
      \end{pasobox}\vspace{3pt}
      \begin{pasobox}[4]
        \AlmFontSmall Elige la \textbf{escala}: mayor valor $\times\;1{,}1$
        para el máximo del eje.
      \end{pasobox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{pasobox}[5]
        \AlmFontSmall \textbf{Representa} cada par $(x,y)$
        de la tabla como punto.
      \end{pasobox}\vspace{3pt}
      \begin{pasobox}[6]
        \AlmFontSmall \textbf{Une} los puntos con línea (gráfica lineal)
        o rellena barras (diagrama de barras).
      \end{pasobox}\vspace{3pt}
      \begin{pasobox}[7]
        \AlmFontSmall Añade el \textbf{título} descriptivo.
      \end{pasobox}
...
\begin{frame}{Diagrama de barras: turistas en Almería (ene–jun)}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      xtick=data,
      xticklabel style={font=\AlmFontTiny, rotate=15, anchor=north east},
      ymin=0, ymax=330000,
...
\begin{frame}{Gráfica lineal: temperatura media mensual en Almería}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \node[font=\AlmFontTiny\bfseries, color=AlmTerra, above=4pt] at (axis cs:7,30)
        {30\,°C};
      \node[font=\AlmFontTiny\bfseries, color=AlmAzulM, below=4pt] at (axis cs:1,12)
        {12\,°C};
    \end{axis}
  \end{tikzpicture}
  \end{center}
      ...
      \begin{column}{0.46\textwidth}
        ...
        \begin{tikzpicture}[scale=0.7]
          \begin{axis}[
            ...
            tick label style={font=\AlmFontTiny},
            label style={font=\AlmFontTiny},
            ylabel style={font=\AlmFontTiny},
            ylabel={Visitantes},
            xlabel={Mes},
            ybar, bar width=0.4cm,
            nodes near coords, nodes near coords style={font=\AlmFontTiny},
          ]
