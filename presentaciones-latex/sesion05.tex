...
\begin{frame}{Elementos geométricos básicos}
  \begin{columns}[T]
    ...
    \begin{column}{0.46\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.88]
          ...
          \node[font=\small\bfseries, color=AlmAzulM, right=3pt of P] {$P$};
          \node[font=\tiny, color=AlmGris, right=22pt of P] {punto};

          % ---------- Recta ----------
          \draw[recto, <->] (-1.8, 4.2) -- (2.2, 4.2);
          \node[font=\tiny, color=AlmAzulM] at (-1.5, 4.45) {$r$};
          \node[font=\tiny, color=AlmGris] at (2.8, 4.2) {recta};

          % ---------- Semirrecta ----------
          \node[punto] at (-1.8, 3.2) {};
          \draw[recto, ->] (-1.8, 3.2) -- (2.2, 3.2);
          \node[font=\tiny, color=AlmGris] at (2.8, 3.2) {semirrecta};

          % ---------- Segmento ----------
          \node[punto] (Sa) at (-1.8, 2.2) {};
          \node[punto] (Sb) at (2.2, 2.2) {};
          \draw[recto] (Sa) -- (Sb);
          \node[font=\small\bfseries, color=AlmAzulM, below=2pt] at (Sa) {$A$};
          \node[font=\small\bfseries, color=AlmAzulM, below=2pt] at (Sb) {$B$};
          \node[font=\tiny, color=AlmGris] at (2.8, 2.2) {$\overline{AB}$};
          % Acotación
          \draw[acota] (-1.8,1.78) -- (2.2,1.78);
          \node[font=\tiny, color=AlmGris] at (0.2, 1.52) {longitud medible};

          % Línea separadora
          \draw[AlmAmbar!60, line width=0.6pt, dashed]
            (-2.1,0) -- (3.2,0);
          \node[font=\tiny\bfseries, color=AlmAmbar!80!black]
...
\begin{frame}{Definición y tipos de ángulo}
  \begin{columns}[c]
    ...
    \begin{column}{0.54\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.82]
          ...
          \node[font=\tiny\bfseries, color=AlmAzulM] at (0.7,0.25)
            {$55°$};
          \node[font=\tiny, color=AlmGris] at (0.65,-0.28)
            {agudo};
          ...
          \node[font=\tiny\bfseries, color=AlmAmbar!80!black]
            at (3.2,0.45) {$90°$};
          \node[font=\tiny, color=AlmGris] at (3.15,-0.28)
            {recto};
          ...
          \node[font=\tiny\bfseries, color=AlmTerra] at (5.05,0.35)
            {$120°$};
          \node[font=\tiny, color=AlmGris] at (5.45,-0.28)
            {obtuso};
          ...
          \node[font=\tiny\bfseries, color=AlmVerde] at (1.5,-1.1)
            {$180°$};
          \node[font=\tiny, color=AlmGris] at (1.5,-1.82)
            {llano};
        \end{tikzpicture}
      \end{center}
    \end{column}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.75]
          \draw[recto, color=AlmAzulM]
            (0,0.5) -- (3.5,0.5)
            node[right, font=\tiny\bfseries, color=AlmAzulM]{$r$};
          \draw[recto, color=AlmAzulM]
            (0,1.6) -- (3.5,1.6)
            node[right, font=\tiny\bfseries, color=AlmAzulM]{$s$};
          ...
          \node[font=\tiny, color=AlmGris, right=2pt]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.75]
          \draw[recto, color=AlmTerra]
            (0,1.05) -- (3.5,1.05)
            node[right, font=\tiny\bfseries, color=AlmTerra]{$r$};
          \draw[recto, color=AlmTerra]
            (1.75,0) -- (1.75,2.3)
            node[above, font=\tiny\bfseries, color=AlmTerra]{$s$};
          % Cuadradito ángulo recto
          \draw[rectoang]
            (1.75,1.05) ++(0.22,0) -- ++(0,0.22) -- ++(-0.22,0);
          \node[font=\small\bfseries, color=AlmAmbar!80!black]
            at (2.35,1.5) {$90°$};
        \end{tikzpicture}
      \end{center}
    \end{column}
...
\begin{frame}{Geometría en las calles de Almería}
  \begin{columns}[c]
    \begin{column}{0.50\textwidth}
      ...
      \end{ejemplobox}
      \vspace{6pt}
      \begin{notabox}[Las calles son segmentos]
        \small
        Cualquier calle tiene un inicio y un final:
        es un \textbf{segmento}, no una recta infinita.
      \end{notabox}
    \end{column}
    \begin{column}{0.46\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.85]
          ...
          \node[font=\tiny\bfseries, color=AlmAzul, align=center]
          ...
          \node[font=\tiny\bfseries, color=AlmTerra,
          ...
          % Leyenda
          \node[font=\tiny, color=AlmAzulM] at (3.6,3.45)
            {\textcolor{AlmAzulM}{$\parallel$} paralelas};
          \node[font=\tiny, color=AlmTerra] at (3.65,3.15)
...
\begin{frame}{Todos los elementos en un mapa urbano}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=1.0]
      ...
      \node[font=\tiny\bfseries, color=AlmAzulM] at (-0.3,4.0)
        {$r_1$};
      \node[font=\tiny\bfseries, color=AlmAzulM] at (-0.3,2.2)
        {$r_2$};
      \node[font=\tiny\bfseries, color=AlmAzulM] at (-0.3,0.4)
        {$r_3$};
      \node[font=\tiny, color=AlmAzulM] at (9.3,4.0) {Av.\ Mar};
      \node[font=\tiny, color=AlmAzulM] at (9.3,2.2) {Rambla};
      \node[font=\tiny, color=AlmAzulM] at (9.3,0.4) {C.\ Obispo};

      % ---- Calle perpendicular ----
      \draw[rectot, line width=1.8pt]
        (2.8,-0.4) -- (2.8,4.8);
      \node[font=\tiny\bfseries, color=AlmTerra, rotate=90]
      ...
      \draw[rectov, line width=2pt]
        (5.5,0.4) -- (5.5,2.2);
      \node[font=\tiny\bfseries, color=AlmVerde, rotate=90]
      ...
      \node[font=\tiny\bfseries, color=AlmAzulM, above right=0pt]
        at (Pt) {$P$};
      ...
      \node[draw=AlmAzulC!50, fill=AlmBlanco, rounded corners=2pt,
            inner sep=4pt, font=\tiny, align=left]
        at (1.5,3.35) {
...
\begin{frame}{¡Cuidado con este error!}
      ...
      \begin{column}{0.46\textwidth}
        ...
        \begin{center}
          \begin{tikzpicture}[scale=0.8]
            \node[punto] (A) at (0,0) {};
            \node[font=\small\bfseries, color=AlmAzulM,
                  below=2pt] at (A) {$A$};
            ...
            \node[font=\tiny, color=AlmGris] at (1.75,-0.65)
              {longitud finita};
          \end{tikzpicture}
        \end{center}
      \end{column}
  ...
  \begin{notabox}[Regla de oro]
    \small
    \textbf{Recta} $\to$ sin extremos, infinita. \quad
