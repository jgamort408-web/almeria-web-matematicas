...
\begin{frame}{La comparación revela relaciones}
  \begin{columns}[c]
    ...
    \begin{column}{0.44\textwidth}
      \begin{tikzpicture}[every node/.style={font=\AlmFontScript}]
        \begin{axis}[
          almeria line,
...
\begin{frame}{Correlación: positiva, negativa o nula}
  \begin{columns}[T]
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}\\[4pt]
    \AlmFontFootnote Cuando $x$ $\uparrow$, también $y$ $\uparrow$\\
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}\\[4pt]
    \AlmFontFootnote Cuando $x$ $\uparrow$, $y$ $\downarrow$\\
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}\\[4pt]
    \AlmFontFootnote Los puntos no siguen ningún patrón\\
    ...
    \begin{column}{0.52\textwidth}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          label style={font=\AlmFontSmall},
          title={Temperatura (°C) y turistas ($\times 10^4$)},
          title style={font=\AlmFontSmall\bfseries, color=AlmAzul},
          grid=both,
          ...
          \addlegendentry{\AlmFontFootnote Temperatura}
        \end{axis}
        \begin{axis}[
          width=8cm, height=5.8cm,
          axis y line*=right,
          ...
          \addlegendentry{\AlmFontFootnote Turistas}
        \end{axis}
      \end{tikzpicture}
    \end{column}
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{tikzpicture}[
        nodo/.style={
          ...
          fill=AlmFondo, font=\AlmFontSmall, inner sep=5pt,
        ...
        \draw[AlmGris, dashed, ->, line width=1pt] (T) -- (Tu)
          node[midway, below, font=\AlmFontTiny, color=AlmGris]
          {correlación\,$\neq$\,causa};
      \end{tikzpicture}
      \end{center}
      \vspace{4pt}
      \AlmFontFootnote\color{AlmGris}
...
\begin{frame}{La escala puede engañar}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering
      {\color{AlmTerra}\bfseries\AlmFontSmall Gráfica «alarmista»}\\
    ...
    \begin{column}{0.48\textwidth}
      \centering
      {\color{AlmVerde}\bfseries\AlmFontSmall Gráfica honesta}\\
      (eje $y$ desde 0)\\[4pt]
      \begin{tikzpicture}
        \begin{axis}[
          width=6cm, height=4.2cm,
  ...
  \vspace{6pt}
  \begin{center}
    \AlmFontSmall ¡Los mismos datos, escalas diferentes,
