...
\begin{frame}{Relación y función: ¿cuál es la diferencia?}
  ...
  \begin{tikzpicture}[scale=0.85]
    ...
    \foreach \v/\y in {2/0.6, 4/0, 6/-0.6}
      \node[font=\AlmFontSmall] at (0,\y) {\v};
    ...
    \foreach \v/\y in {-2/0.9, 1/0.3, 2/-0.3, 3/-0.9}
      \node[font=\AlmFontSmall] at (2.8,\y) {\v};
    ...
    \node[above, font=\AlmFontTiny\bfseries, color=AlmGris] at (1.4,1.4) {RELACIÓN};
    % FUNCIÓN (der)
    ...
    \foreach \v/\y in {1/0.6, 2/0, 3/-0.6}
      \node[font=\AlmFontSmall] at (5.4,\y) {\v};
    \node[draw=AlmVerde, ellipse, minimum width=1.2cm, minimum height=2.2cm,
          fill=AlmVerde!10] at (8.2,0) {};
    \foreach \v/\y in {3/0.6, 6/0, 9/-0.6}
      \node[font=\AlmFontSmall] at (8.2,\y) {\v};
    \draw[->, AlmVerde, thick] (6.0, 0.6) -- (7.6, 0.6);
    \draw[->, AlmVerde, thick] (6.0, 0.0) -- (7.6, 0.0);
    \draw[->, AlmVerde, thick] (6.0,-0.6) -- (7.6,-0.6);
    \node[above, font=\AlmFontTiny\bfseries, color=AlmGris] at (6.8,1.4) {FUNCIÓN};
  \end{tikzpicture}
  \end{center}
\end{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      \node[draw=AlmAzulM, fill=AlmAzulC!12, rounded corners=5pt,
            font=\AlmFontSmall\bfseries, inner sep=6pt] {
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.42\textwidth}
      \begin{ejemplobox}
        ...
        2\,km cuestan 5{,}00\,€\\[4pt]
        $k = \dfrac{5{,}00\,\text{€}}{2\,\text{km}} = 2{,}50\,\text{€}/\text{km}$\\[4pt]
        Verificamos con $x=4$:\\
        $y = 2{,}50 \times 4 = 10{,}00\,\text{€}$ \correcto
      \end{ejemplobox}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Gráfica de proporcionalidad directa: tarifa de taxi en Almería}
  \begin{columns}[c]
    \begin{column}{0.60\textwidth}
      \begin{tikzpicture}
        \begin{axis}[
          ...
          \node[font=\AlmFontTiny\bfseries, color=AlmTerra, anchor=west]
            at (axis cs: 3.5, 10.5) {$y = 2{,}5\,x$};
          % pendiente k
          \draw[<->, AlmVerde, thick]
            (axis cs: 2, 5) -- (axis cs: 3, 5)
            node[midway, below, font=\AlmFontTiny\bfseries, color=AlmVerde] {$\Delta x = 1$};
          \draw[<->, AlmVerde, thick]
            (axis cs: 3, 5) -- (axis cs: 3, 7.5)
            node[midway, right, font=\AlmFontTiny\bfseries, color=AlmVerde] {$k = 2{,}5$};
        \end{axis}
      \end{tikzpicture}
    \end{column}
    \begin{column}{0.38\textwidth}
      ...
      \end{formulabox}
      \vspace{0.2cm}
      {\AlmFontTiny La recta \textbf{pasa por el origen} y tiene pendiente $k = 2{,}5$.}
    \end{column}
  \end{columns}
\end{frame}
  ...
  \begin{columns}[t]
    \begin{column}{0.32\textwidth}
      \begin{ejemplobox}
        ...
        3 viajes $= 3 \times 1{,}40 = 4{,}20\,\text{€}$\\[4pt]
        \[y = 1{,}40\,x\]
        $k = 1{,}40\,\text{€}/\text{viaje}$
      \end{ejemplobox}
    \end{column}
    \begin{column}{0.32\textwidth}
      \begin{ejemplobox}
  ...
  \begin{center}
    \begin{tikzpicture}
      \node[draw=AlmAmbar, fill=AlmAmbar!10, rounded corners=4pt,
            font=\AlmFontSmall, inner sep=8pt, text width=10cm, align=center] {
  ...
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      ...
      \begin{tabular}{|>{\bfseries\color{AlmAzulM}}c|c|c|}
        \hline
        \rowcolor{AlmAzul!15}
        \textbf{Viajes ($x$)} & \textbf{Coste ($y$, €)} & \textbf{$y/x$} \\
        \hline
        1  & 1{,}40  & 1{,}40 \\
        2  & 2{,}80  & 1{,}40 \\
        3  & 4{,}20  & 1{,}40 \\
...
\begin{frame}{Proporcional vs.\ lineal: ¡no confundir!}
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      \begin{block}{\normalsize\correcto Proporcional: $y = 2{,}5\,x$}
      ...
      \end{block}
            ...
            \begin{alertblock}{\normalsize\incorrecto Lineal (no proporcional): $y = 2{,}40 + 1{,}20\,x$}
    ...
    \begin{columns}[t]
      \begin{column}{0.47\textwidth}
        \begin{center}
          ...
          $y = 3x$\\[4pt]
          {\AlmFontSmall Pasa por el origen $(0,0)$}\\
          {\AlmFontSmall $y/x = 3$ siempre}
        \end{center}
      \end{column}
      \begin{column}{0.47\textwidth}
        \begin{center}
          ...
          $y = 3x + 5$\\[4pt]
          {\AlmFontSmall No pasa por el origen}\\
          {\AlmFontSmall $y/x \neq$ constante}
        \end{center}
      \end{column}
    \end{columns}
