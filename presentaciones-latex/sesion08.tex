  ...
  \begin{columns}[c]
    \begin{column}{0.54\textwidth}
      ...
      \begin{notabox}[Analogía]
        \small El área es como el \textbf{césped} a segar dentro
      ...
      \small (dos dimensiones $\Rightarrow$ el exponente es 2)
    \end{column}
    \begin{column}{0.42\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \draw[AlmAzulC!30, very thin, step=0.5]
          (0,0) grid (3.5,2.5);
        \node[font=\small\bfseries, color=AlmVerde!70!black]
          at (1.75,1.25) {ÁREA};
        \node[font=\tiny\bfseries, color=AlmTerra]
          at (1.75,-0.3) {Perímetro (borde)};
        % Cota
        \draw[acota] (0,-0.65) -- (3.5,-0.65)
          node[midway,below,font=\tiny]{base $b$};
        \draw[acota] (3.9,0) -- (3.9,2.5)
          node[midway,right,font=\tiny]{altura $h$};
      \end{tikzpicture}
      \end{center}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[c]
    \begin{column}{0.50\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \node[font=\small\bfseries, color=AlmVerde!70!black]
          at (1.0,1.0) {$A = l^2$};
        \node[below, font=\scriptsize\bfseries, color=AlmVerde]
          at (1.0,-0.9) {Cuadrado};
      \end{tikzpicture}
      \end{center}
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \node[below, font=\scriptsize\bfseries, color=AlmAzulM]
    ...
    \begin{column}{0.50\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \draw[acota] (0,-0.5) -- (3.0,-0.5)
          node[midway,below,font=\scriptsize]{$b$};
        \node[font=\small\bfseries, color=AlmTerra]
          at (1.5,0.6) {$\dfrac{b \times h}{2}$};
        \node[below, font=\scriptsize\bfseries, color=AlmTerra]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \draw[acota] (0.5,-0.5) -- (3.1,-0.5)
          node[midway,below,font=\scriptsize]{$b$};
        \node[font=\small\bfseries, color=AlmVerde]
    ...
    \begin{column}{0.50\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \draw[acota] (0.4,-0.5) -- (3.2,-0.5)
          node[midway,below,font=\tiny]{$B$ (base mayor)};
        \draw[acota] (0.8,1.9) -- (2.8,1.9)
          node[midway,above,font=\tiny]{$b$ (base menor)};
        \draw[AlmGris, dashed, thin] (0.8,0) -- (0.8,1.6);
        \draw[acota] (-0.35,0) -- (-0.35,1.6)
          node[midway,left,font=\tiny]{$h$};
        \node[below, font=\scriptsize\bfseries, color=AlmAmbar!80!black]
          at (1.8,-0.9) {Trapecio};
      \end{tikzpicture}
      \end{center}
...
\begin{frame}{Problema resuelto: manzana trapezoidal}
  \begin{definicionbox}{Enunciado}
    \small Una manzana de Almería tiene forma de trapecio con
  ...
  \begin{columns}[t]
    \begin{column}{0.50\textwidth}
      \begin{pasobox}[1]
        \small Identificar la fórmula del trapecio:
        \[A = \frac{(B + b)}{2} \times h\]
      \end{pasobox}
      \vspace{0.2cm}
      \begin{pasobox}[2]
...
\begin{frame}{Ejercicio 1 — RECORDAR \dificultad{1}}
  ...
  \vspace{0.15cm}
  \begin{notabox}[Pista]
    \small Para el triángulo, la altura debe ser perpendicular a la base.
  \end{notabox}
\end{frame}
  ...
  \begin{columns}[c]
    \begin{column}{0.40\textwidth}
      ...
      \begin{tikzpicture}[scale=0.60]
        ...
        \draw[acota] (0,-0.5) -- (2.0,-0.5)
          node[midway,below,font=\tiny]{10 m};
        \node[font=\scriptsize\bfseries, color=AlmVerde] at (1.0,1.0) {?};
      \end{tikzpicture}
      \end{center}
    \end{column}
    \begin{column}{0.55\textwidth}
      ...
      \begin{tikzpicture}[scale=0.60]
        ...
        \draw[acota] (0,-0.5) -- (3.0,-0.5)
          node[midway,below,font=\tiny]{15 m};
        \draw[acota] (3.4,0) -- (3.4,1.0)
          node[midway,right,font=\tiny]{5 m};
        \node[font=\scriptsize\bfseries, color=AlmAzulM] at (1.5,0.5) {?};
      \end{tikzpicture}
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}{Ejercicio 3 — APLICAR \dificultad{3}}
  \begin{aplicarbox}
    \small Se quiere crear una \textbf{zona verde triangular}
  ...
  \begin{columns}[c]
    \begin{column}{0.42\textwidth}
      ...
      \begin{tikzpicture}[scale=0.55]
        ...
        \draw[acota] (0,-0.6) -- (4.5,-0.6)
          node[midway,below,font=\tiny]{300 m};
        \draw[acota] (2.6,0) -- (2.6,2.25)
          node[midway,right,font=\tiny]{150 m};
        \node[font=\scriptsize\bfseries, color=AlmVerde!70!black]
    ...
    \begin{column}{0.54\textwidth}
      \begin{pasobox}[1]
        \scriptsize $A = \dfrac{b \times h}{2}
          = \dfrac{300 \times 150}{2} = ?\ \text{m}^2$
      \end{pasobox}
      \vspace{0.15cm}
      \begin{pasobox}[2]
        \scriptsize $A_{\text{ha}} = \dfrac{A_{\text{m}^2}}{10{,}000}$
      \end{pasobox}
      \vspace{0.15cm}
      \begin{pasobox}[3]
        \scriptsize $\text{Coste} = A_{\text{m}^2} \times 8$~€/m$^2$
      \end{pasobox}
    \end{column}
  \end{columns}
\end{frame}
